<h1 align="center">💘 ek0ms savi0r 💘</h1>
<p align="center">cyber mama 🧸 | crypto baby 🪙 | chaos artist 🎨 | defender of the digital playground 🛡️</p>
...
- 💘 **Girly aesthetics + terminal magic** – pink prompts and powerful payloads
- 🧠 **Cybersecurity** – botnets, BLE mesh networks, Evil APs, C2 detection… you name it
- 🛜 **Wireless hacking** – BLE, Wi-Fi, fuzzing, mesh botnets. I love jamming things just right 💥
- 🪙 **Crypto forensics** – 5 years in blockchain, DeFi, and project dev
- 👩‍👧 **Being a mom** – and turning that mama bear energy into digital protection 🐻
- 🎀 **Building tools that teach and empower** – especially for other femmes in cyber!
...
| Project | Description |
|--------|-------------|
| [**Spam Jam**](https://github.com/ekomsSavior/Spam-Jam) | A BLE spamming & jamming tool that’s part cute, part chaos 💘📡 |
| [**JamFi**](https://github.com/ekomsSavior/JamFi) | Wi-Fi deauth & Evil AP toolkit for wardriving warriors 🚗💥 |
| [**Info Glow**](https://github.com/ekomsSavior/Info-Glow) | The cutest OSINT CLI ever – sparkly recon for serious researchers 🧚‍♀️🕵️ |
| [**BotSchool**](https://github.com/ekomsSavior/BotSchool) | A red team education botnet simulator 🧠📚 designed for learning and love |
| [**Buzzkill**](https://github.com/ekomsSavior/Spam-Jam) (coming soon!) | BLE fuzzing module to find vulnerabilities in connected chaos 🐝💣 |
| [**EVA Project**](#) | My AI assistant, built with care to help defend, empower, and protect the ones I love 🤖🫶 |
